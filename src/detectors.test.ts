...
describe("detectors", () => {
  ...
  it("detects all sensitive entities in Dutch customer service document", () => {
    const doc = [
      ...
      "KvK nr 27.157.000",
      "Lid-/Relatienummer 309874300",
      "Factuurnummer 2003101997",
      "Factuurdatum 26 juli 2026",
      "Producten & diensten Periode Bedrag (EUR) Totaal (EUR)",
      "Wegenwacht Nederland Standaard",
      "T.M.R. Welles 309874300",
      "27-08-26 t/m 26-08-27 122,25",
      "Wegenwacht Bromfiets Service",
      "T.M.R. Welles 309874300",
      "27-08-26 t/m 26-08-27 85,25",
    ].join("\n");
